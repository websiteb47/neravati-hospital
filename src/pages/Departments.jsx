...
// import { departments } from '../data/doctors'; // ensure bilingual data if needed
...
//     rating: 4.9,
//     patients: 1600,
//     description: "Specialist in diabetes, thyroid, hypertension, heart diseases, chest infections, viral fevers, dengue, typhoid, joint pains, asthma, and more."
//   },
//   {
//     id: 6,
//     name: "Dr. A. Aruna Kumari",
...
//   const { currentLanguage } = useLanguage(); // ✅ bilingual support
...
//         (d) => d.name.en.toLowerCase().replace(/\s+/g, '-') === hash
//       );
...
//     const name = dept.name[currentLanguage]?.toLowerCase();
//     const desc = dept.description[currentLanguage]?.toLowerCase();
//     return name?.includes(searchTerm?.toLowerCase()) || desc.includes(searchTerm?.toLowerCase());
//   });

//   const departmentsToDisplay = selectedDept ? [selectedDept] : filteredDepartments;
...
//               doc.department.toLowerCase().includes(department.name.en.toLowerCase())
//             );

//             return (
//               <div key={department.id} id={department.name.en.toLowerCase().replace(/\s+/g, '-')} className="bg-white rounded-xl p-8 mb-16 shadow">
...
//                       {department.description[currentLanguage]}
//                     </p>
...
//                           {currentLanguage === 'en'
//                             ? `Expert Doctors specializing in ${department.name.en}`
//                             : `నిపుణులు ${department.name.te} లో ప్రత్యేకత కలిగిన వైద్యులు`}
//                         </span>
//                       </div>
//                       <div className="flex items-center space-x-3">
...
//                             : 'ఖచ్చితమైన నిర్ధారణ మరియు చికిత్స కోసం అత్యాధునిక సదుపాయాలు'}
//                         </span>
//                       </div>
//                       <div className="flex items-center space-x-3">
...
//                             : 'నిర్ధారణ నుండి చికిత్స మరియు ఫాలో-అప్ వరకు సమగ్ర సంరక్షణ'}
//                         </span>
//                       </div>
//                     </div>
//                   </div>
...
//                       {currentLanguage === 'en' ? 'Services Offered' : 'అందించే సేవలు'}
//                     </h4>
...
//                       {currentLanguage === 'en'
//                         ? `Our Doctors in ${department.name.en}`
//                         : `${department.name.te} విభాగంలో మా వైద్యులు`}
//                     </h4>
//                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
//                       {relatedDoctors.map((doc) => (
//                         <div key={doc.id} className="border rounded-lg shadow-sm p-6 bg-white">
//                           <img src={doc.image} alt={doc.name} className="w-full object-cover rounded-lg mb-4" />
//                           <h5 className="text-xl font-semibold text-gray-900">{doc.name}</h5>
//                           <p className="text-gray-600">{doc.specialty}</p>
//                           <p className="text-sm text-gray-500 mt-2">{doc.experience}</p>
//                           <p className="text-sm text-gray-500">{doc.education}</p>
//                           <p className="text-sm text-gray-500 mt-1">
//                             {currentLanguage === 'en' ? 'Availability:' : 'లభ్యత:'} {doc.availability}
//                           </p>
...
//         {/* Special Clinics Section (unchanged) */}
//         {selectedDept?.id === 7 && (
//           <div className="container mx-auto px-4">
//             <div className="text-center mb-16">
//               <h2 className="text-4xl font-bold text-gray-900 mb-4">
//                 {currentLanguage === 'en' ? 'Special Clinics' : 'ప్రత్యేక క్లినిక్‌లు'}
//               </h2>
//               <p className="text-xl text-gray-600 max-w-3xl mx-auto">
//                 {currentLanguage === 'en'
//                   ? 'Explore our specialized clinics that offer advanced treatments and collaborations for better care.'
//                   : 'మరింత మెరుగైన సంరక్షణ కోసం అధునాతన చికిత్సలు మరియు సహకారాలను అందించే మా ప్రత్యేక క్లినిక్‌లను అన్వేషించండి.'}
//               </p>
//             </div>
//             {/* (Vertigo & Allergy clinic content same as before) */}
//           </div>
//         )}
//       </section>
//     </div>
