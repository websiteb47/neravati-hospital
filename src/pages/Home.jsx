      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Link
              to="/services"
              className="inline-flex items-center space-x-2 bg-blue-900 hover:bg-blue-950 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-200"
            >
